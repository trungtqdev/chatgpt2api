...
export function UserKeysCard() {
  ...
  const handleCopy = async (value: string) => {
    try {
      ...
      toast.error("Sao chép thất bại, vui lòng chép thủ công");
    }
  };
        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold tracking-tight">Quản lý khóa người dùng (User Keys)</h2>
                <p className="text-sm text-stone-500">Tạo khóa chuyên dụng cho người dùng. Người dùng chỉ có quyền tạo ảnh, không xem được cài đặt hay nhóm tài khoản.</p>
              </div>
            </div>
          ...
          {revealedKey ? (
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-900">
              <div className="font-medium">Khóa mới chỉ hiển thị một lần duy nhất, vui lòng lưu lại ngay:</div>
          ...
          {isLoading ? (
            ...
            <div className="rounded-xl bg-stone-50 px-6 py-10 text-center text-sm text-stone-500">
              Chưa có khóa người dùng. Nhấp vào nút góc trên bên phải để tạo và chia sẻ cho người khác.
            </div>
          ) : (
                    ...
                    <div className="min-w-0 space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Badge variant={item.enabled ? "success" : "secondary"} className="rounded-md">
                          {item.enabled ? "Đang kích hoạt" : "Đã vô hiệu hóa"}
                        </Badge>
                      </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            <DialogTitle>Tạo khóa người dùng mới</DialogTitle>
            <DialogDescription className="text-sm leading-6">
              Nhập tên gợi nhớ để phân biệt người dùng; sau khi tạo sẽ hiển thị chuỗi khóa bí mật một lần duy nhất.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">Tên gợi nhớ (tùy chọn)</label>
            <Input
              value={name}
              onChange={(event) => setName(event.target.value)}
              placeholder="Ví dụ: Người dùng A, Team Marketing..."
      ...
      <Dialog open={Boolean(deletingItem)} onOpenChange={(open) => (!open ? setDeletingItem(null) : null)}>
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Bạn có chắc muốn xóa khóa của "{deletingItem?.name}"? Sau khi xóa sẽ không thể gọi API được nữa.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
      ...
      >
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Có thể sửa tên gợi nhớ; nếu muốn đổi khóa, hãy nhập chuỗi khóa mới. Để trống để giữ nguyên khóa cũ.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-700">Tên gợi nhớ</label>
              <Input
                value={editName}
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-700">Chuỗi khóa mới (tùy chọn)</label>
              <Input
                value={editKey}
              ...
              <p className="text-xs leading-5 text-stone-500">
                Sau khi lưu, khóa cũ sẽ hết hiệu lực ngay lập tức. Hệ thống chỉ lưu bản mã băm (hash), không hiển thị lại khóa.
              </p>
            </div>
          </div>
          <DialogFooter>
